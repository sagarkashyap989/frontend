...
const handleSubmit = (e) =>{
  ...
  <div class="mb-4">
    ...
    <div class="mb-6">
      ...
      <input type="password" name='password' value={password} onChange={e=> onChange(e)}  class={`shadow appearance-none border  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline  `} id="password" placeholder="******************" />
